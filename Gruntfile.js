module.exports = function (grunt) {
  ...
  var clubs = ['aire', 'albania', 'ayroc', 'bado', 'baoc', 'basoc', 'bko', 'boc', 'bok', 'bl', 'chig', 'claro', 'clyde', 'coboc', 'cuoc', 'cvfr', 'darkandwhite', 'dee',
    ...
    'kongmmm', 'lamm', 'leioc', 'loc', 'log', 'lok', 'lvo', 'maroc', 'masterplanadventure', 'mdoc', 'mid-wales', 'moravian', 'mvoc', 'nato', 'ngoc', 'noroc', 'nwo', 'od', 'omm',
    'ouoc', 'oureaevents', 'pfo', 'potoc', 'quantock', 'rafo', 'roxburghreivers', 'run-herts', 'sa', 'sarum', 'saxons', 'sboc', 'scottish6days', 'seloc', 'slow', 'slmm', 'smbo',
    'smoc', 'sn', 'so', 'soa', 'soc', 'solway', 'sportident', 'sroc', 'stag', 'start', 'suffoc', 'swoc', 'syo', 'tay', 'test', 'purple-thistle', 'tinto', 'tvoc', 'walton',
    'waoc', 'wcoc', 'wim', 'wmoc', 'wrekin', 'wsco2008', 'wsx'];
